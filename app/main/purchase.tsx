...
const ORDERS = [
  { id: 'ORD-2025-1156', date: '15 Nov 2025', time: '10:30 AM', value: '₹13,45,670', volume: '2,568L', expanded: false },
  { id: 'ORD-2025-1157', date: '16 Nov 2025', time: '11:15 AM', value: '₹7,89,320',  volume: '1,234L', expanded: false },
  { id: 'ORD-2025-1158', date: '17 Nov 2025', time: '3:00 PM',  value: '₹4,20,000',  volume: '980L',   expanded: false },
  { id: 'ORD-2025-1159', date: '18 Nov 2025', time: '9:00 AM',  value: '₹6,50,000',  volume: '1,450L', expanded: false },
];
    ...
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.content}>
        ...
        <AdvancedFilterSheet
          ...
          onApply={(f) => { console.log('Purchase filters:', f); setFilterVisible(false); }}
          variant="purchase"
        />
...
const styles = StyleSheet.create({
  ...
  searchRow: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, gap: 8, marginBottom: 14 },
  ...
  summaryCard: { backgroundColor: COLORS.primary, borderRadius: 16, marginHorizontal: 16, padding: 18, marginBottom: 16 },
  ...
  growthBadge: { backgroundColor: '#22C55E', borderRadius: 20, paddingHorizontal: 12, paddingVertical: 5 },
  ...
  orderCard: { backgroundColor: COLORS.card, borderRadius: 14, padding: 16, marginBottom: 12 },
  ...
  chevronBtn: { width: 34, height: 34, borderRadius: 17, backgroundColor: COLORS.surface, justifyContent: 'center', alignItems: 'center' },
  chevronBtnActive: { backgroundColor: COLORS.primary },
  dateRow: { flexDirection: 'row', gap: 8, marginBottom: 12 },
  dateBadge: { flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: COLORS.surface, borderRadius: 8, paddingHorizontal: 10, paddingVertical: 5 },
  ...
  viewDetailBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, borderWidth: 1, borderColor: COLORS.primary, borderRadius: 8, paddingVertical: 9 },
