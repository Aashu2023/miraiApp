...
import AdvancedFilterSheet from '../../components/AdvancedFilterSheet'; // ← NEW

const INVOICES = [
  {
    id: 'INV-2025-0342', status: 'Overdue',
    date: '15 Nov 2025', time: '10:30 AM',
    amount: '₹3,45,670', payment: '-',
    paymentColor: COLORS.textMuted,
    product: 'Premium Exterior', items: '8 items • 2,450L',
    orderId: 'ORD-2024-1156', cardBg: '#2D1A1A',
    statusBg: '#EF4444', statusColor: '#fff',
  },
  {
    id: 'INV-2025-0343', status: 'Paid',
    date: '16 Nov 2025', time: '11:00 AM',
    amount: '₹1,25,340', payment: '14 Nov 2025',
    paymentColor: '#22C55E',
    product: 'Classic Interior', items: '5 items • 1,150L',
    orderId: 'ORD-2024-1157', cardBg: COLORS.card,
    statusBg: '#22C55E', statusColor: '#fff',
  },
  {
    id: 'INV-2025-0344', status: 'Pending',
    date: '17 Nov 2025', time: '09:15 AM',
    amount: '₹2,80,000', payment: '-',
    paymentColor: COLORS.textMuted,
    product: 'Eco-Friendly Urban', items: '6 items • 1,800L',
    orderId: 'ORD-2024-1158', cardBg: COLORS.card,
    statusBg: '#F97316', statusColor: '#fff',
  },
];
...
export default function InvoiceScreen() {
  ...
  const [filterVisible, setFilterVisible] = useState(false); // ← NEW
    ...
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.content}>
        ...
        <AdvancedFilterSheet
          ...
          onApply={(f) => { console.log('Invoice filters:', f); setFilterVisible(false); }}
          variant="invoice"
        />
            ...
            <View key={inv.id} style={[styles.invoiceCard, { backgroundColor: inv.cardBg }]}>
              ...
              <View style={styles.amountRow}>
                ...
                <View style={{ alignItems: 'flex-end' }}>
                  ...
                  <Text style={[styles.paymentValue, { color: inv.paymentColor }]}>{inv.payment}</Text>
                </View>
              </View>
...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: COLORS.primary, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 12, gap: 10 },
  backBtn: { padding: 4 },
  headerTitle: { flex: 1, color: COLORS.background, fontFamily: FONTS.bold, fontSize: 20 },
  headerRight: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  newArrivalBadge: { backgroundColor: '#8B5CF6', borderRadius: 12, paddingHorizontal: 8, paddingVertical: 4 },
  newArrivalText: { color: '#fff', fontFamily: FONTS.bold, fontSize: 9, textAlign: 'center' },
  iconBtn: { width: 36, height: 36, borderRadius: 18, backgroundColor: 'rgba(0,0,0,0.15)', justifyContent: 'center', alignItems: 'center' },
  content: { flex: 1, backgroundColor: COLORS.surface, paddingTop: 16 },
  searchRow: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, gap: 8, marginBottom: 16 },
  searchBox: { flex: 1, flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.card, borderRadius: 24, paddingHorizontal: 14, paddingVertical: 10, gap: 8 },
  searchInput: { flex: 1, color: COLORS.text, fontFamily: FONTS.regular, fontSize: 14 },
  actionBtn: { width: 40, height: 40, borderRadius: 20, backgroundColor: COLORS.card, justifyContent: 'center', alignItems: 'center' },
  ...
  invoiceCard: { borderRadius: 16, padding: 16, marginBottom: 14 },
  ...
  dateBadge: { flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: 'rgba(255,255,255,0.07)', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 5 },
  ...
  productIcon: { width: 40, height: 40, borderRadius: 10, backgroundColor: 'rgba(255,255,255,0.07)', justifyContent: 'center', alignItems: 'center' },
  ...
  viewBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, backgroundColor: 'rgba(255,255,255,0.1)', borderRadius: 10, paddingVertical: 12 },
  viewBtnText: { color: COLORS.text, fontFamily: FONTS.semibold, fontSize: 14 },
  downloadBtn: { flex: 1.4, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, backgroundColor: COLORS.primary, borderRadius: 10, paddingVertical: 12 },
